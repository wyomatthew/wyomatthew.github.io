...
I hear what you're thinking (and by you I mean me): "Which is it then? Should strategies pick a players in weaker roles who out-perform their peers by wider margins or players in stronger roles who out-perform their peers by more modest margins?" Well, ideally, you should pick players who have both: players in strong roles who out-perform their peers by a wide margin. If there are no options that satisfy both, then the tradeoff lies in the numbers (by *how much* is the player out-performing? by *how much* is their role stronger?).
